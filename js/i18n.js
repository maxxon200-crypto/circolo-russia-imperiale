...
(function () {
  ...
  var DICT = {
    ...
    "romanov-label": { it: "In preparazione", ru: "Материал готовится" },
    "romanov-title": { it: "Storia della famiglia Romanov", ru: "История семьи Романовых" },
    "romanov-excerpt": { it: "Un nuovo approfondimento dedicato alla dinastia Romanov. L'articolo completo sarà pubblicato a breve.", ru: "Новый материал, посвящённый династии Романовых. Полный текст статьи будет опубликован в ближайшее время." },
    "romanov-body": { it: "<p>L'articolo sulla storia della famiglia Romanov è in preparazione. Il testo completo sarà inserito in questa pagina non appena disponibile.</p>", ru: "<p>Статья об истории семьи Романовых готовится. Полный текст будет размещён на этой странице, как только он будет доступен.</p>" },
  ...
  var EN = {
    ...
    "romanov-label": "In preparation",
    "romanov-title": "History of the Romanov family",
    "romanov-excerpt": "A new study devoted to the Romanov dynasty. The full article will be published shortly.",
    "romanov-body": "<p>The article on the history of the Romanov family is in preparation. The full text will be added to this page as soon as it is available.</p>",
